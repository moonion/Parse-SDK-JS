...
var DefaultController = {
  ...
  //     }).join('&');
  //
  //     const url = 'http://localhost:1337/parse/apps/'+ CoreManager.get('APPLICATION_ID') +'/request_password_reset';
  //
  //     fetch(url, {
  //         method: 'POST',
  //         headers: {
  ...
  //     })
  //         .then(reply => {
  //             console.log(1111111, reply);
  //             dispatch({type: SET_RESET_PASSWORD_STATUS, payload: 'success'})
  //         })
  //         .catch(err => {
  //
  //             console.log("####### ERROR #######", err);
  //
  //             dispatch({type: SET_RESET_PASSWORD_STATUS, payload: 'error'})
  //         })
  //
  // },
